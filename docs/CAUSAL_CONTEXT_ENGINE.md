# Causal Context Engine — Analysis Ultimate v3.2

## Objectif

Le moteur contextuel ne traite plus les travaux comme un onglet séparé. Chaque diagnostic commercial généré par Analysis Ultimate est automatiquement soumis à un test de contexte Clermont.
