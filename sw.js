const CACHE = 'analysis-ultimate-v3.2.0-causal-context';
const LOCAL_ASSETS = [
  './','./index.html','./manifest.webmanifest','./css/styles.css','./js/constants.js','./js/utils.js','./js/csv.js','./js/xlsx-lite.js','./js/importer.js',
  './js/storage.js','./js/geo.js','./js/intelligence.js','./js/autopilot.js','./js/analytics.js','./js/public-context.js','./js/causal-context.js','./js/ui.js','./js/app.js','./data/public-context.json','./data/public-context-history.json'
];
